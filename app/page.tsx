...
const [prospectProperties, setProspectProperties] = useState<ProspectProperty[]>([]) // New state
...
useEffect(() => {
  fetchProperties()
  fetchStats()
  fetchProspectPropertiesPreview() // New fetch call
}, [selectedCategory])
...
const fetchProspectPropertiesPreview = async () => {
  try {
    // Fetch a limited number of prospect properties for preview
  ...
  <div className="container mx-auto px-4 py-8">
    ...
    <section className="text-center py-12 mb-12">
      <h1 className="text-4xl md:text-6xl font-bold mb-6">
        Community-Driven Property Evaluation
      </h1>
      <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
        Discover, evaluate, and vote on properties in your community.
        Join thousands of users making informed property decisions together.
      </p>
      {!isAuthenticated && (
