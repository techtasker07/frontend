...
export default function EditMarketplacePropertyPage() {
  ...
  const fetchListingData = async () => {
    try {
      ...
      const populatedData: FormData = {
        ...
        year_of_construction: data.year_of_construction?.toString() || '',
        bedrooms: data.bedrooms?.toString() || '',
        bathrooms: data.bathrooms?.toString() || '',
        toilets: data.toilets?.toString() || '',
        kitchen_size: data.kitchen_size || '',
        dining_room: data.dining_room || false,
  ...
  const handleSubmit = async () => {
    ...
    if (!user || !originalData) {
      setError('Authentication or listing data missing');
      return;
    }
    ...
    try {
      ...
      console.log('Updating marketplace listing:', updateData);
      ...
      if (imagesToDelete.length > 0) {
        ...
        if (deleteError) {
          console.warn('Failed to delete some images:', deleteError);
      ...
      if (uploadedImageUrls.length > 0) {
        try {
          ...
          if (!response.ok) {
            ...
            toast.warning('Property updated successfully, but there was an issue saving new images.');
          } else {
      ...
      if (virtualTourImages.length > 0) {
        try {
          setUploadProgress("Updating virtual tour...");
          ...
          if (!tourResponse.ok) {
            ...
            toast.warning('Property updated successfully, but there was an issue updating the virtual tour.');
          } else {
            const tourResult = await tourResponse.json();
            console.log('Virtual tour updated successfully:', tourResult);
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            {authLoading ? 'Verifying authentication...' : 'Loading listing data...'}
          </p>
        </div>
      </div>
    );
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <p className="text-muted-foreground mb-4">You must be logged in to edit a marketplace listing.</p>
  ...
  // Show error if user doesn't own the listing
  if (error && originalData && originalData.user_id !== user?.id) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Edit Marketplace Listing</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="images">Additional Property Images</Label>
              <Input
                id="images"
                name="images"
                type="file"
              ...
              <p className="text-xs text-muted-foreground">
                Select additional image files to add to your listing.
              </p>
          ...
          {/* Virtual Tour Images */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">Update Virtual Tour (Optional)</h3>
            <p className="text-sm text-muted-foreground">
              Upload new 360° panoramic images to replace the current virtual tour.
            </p>

            <div className="space-y-2">
              <Label htmlFor="virtual-tour-images">New 360° Virtual Tour Images</Label>
              <Input
              ...
              />
              <p className="text-xs text-muted-foreground">
                Select multiple 360° panoramic images. This will replace the existing virtual tour.
              </p>
