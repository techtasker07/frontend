...
function CrowdFundingSuccessPageContent() {
  ...
  const handlePublishCampaign = async () => {
    ...
    try {
      ...
      if (!storedData) {
        toast.error('Campaign form data not found. Please start over.');
      ...
      <div className="max-w-md mx-auto">
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Your payment has been processed successfully. Ready to launch your campaign?
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="pt-4 space-y-2">
              ...
              >
                {publishing ? 'Publishing Campaign...' : 'Publish Campaign'}
              </Button>
              <Button
                variant="outline"
                ...
                onClick={() => {
                  ...
                  if (printWindow && paymentDetails) {
                    printWindow.document.write(`
                      ...
                      <html>
                        <head>
                          <title>Payment Receipt - Crowd Funding</title>
                          <style>
                            body {
                        ...
                        <body>
                          <div class="header">
                            ...
                            <div>Crowd Funding Campaign Setup</div>
                          </div>
...
export default function CrowdFundingSuccessPage() {
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <CrowdFundingSuccessPageContent />
    </Suspense>
  );
}